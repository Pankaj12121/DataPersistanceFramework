...
import com.demo.framework.core.exceptions.ScriptExecutionException;
import com.demo.frameworkcore.PageElement;
import com.demo.frameworkcore.RandomCodeGenerator;
...
public abstract class WebPage {
	...
	protected void sendKeys (PageElement pageElement, String value) {
		try {
			...
			System.out.println("Typed Value: " + value + "' in " + pageElement.getName());
			//frameworkServices.logMessage("Typed Value: " + value + "' in " + pageElement.getName(), logger);
		} catch (Exception exception) { 
			throw new ScriptExecutionException ("Failed to type value: '"   );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void sendKeys (PageElement pageElement, Keys key) {
		try {
			...
			throw new ScriptExecutionException("Failed to press : '"   );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void clearAndSendKeys (PageElement pageElement, String value) {
		try {
			...
			throw new ScriptExecutionException ("Failed to clear and type value: '"   );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void click(PageElement pageElement) {
		try {
			...
			System.out.println("Clicked on: " + pageElement.getName());
			Thread.sleep(3000);
			//frameworkServices.logMessage("Clicked on: " + pageElement.getName(), logger);
		} catch (Exception exception) {
			throw new ScriptExecutionException ("Failed to click on : '"  );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void check(PageElement pageElement) {
		try {
			...
			throw new ScriptExecutionException ("Failed to check: '"  );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void unCheck(PageElement pageElement) {
		try {
			...
			throw new ScriptExecutionException ("Failed to uncheck: '");
		} finally {
			pageElement = null;
		}
	}
	...
	protected String acceptAlertAndReturnConfirmationMessage() {
		try {
			...
			throw new ScriptExecutionException ("failed to accept alert on " );
		}
	}
	...
	protected String dismissAlertAndReturnConfirmationMessage() {
		try {
			...
			throw new ScriptExecutionException ("failed to dismiss alert on ");
		}
	}
	...
	protected void doubleClick(PageElement pageElement) {
		try {
			...
			throw new ScriptExecutionException("Failed to doubleclick: '" );
		} finally {
			pageElement = null;
		}
	}
	...
	protected String getText(PageElement pageElement) {
		...
		try {
			...
			throw new ScriptExecutionException("Failed to fetch text: '" );
		} finally {
			pageElement = null;
		}
		return text;
	...
	protected boolean isElementDisplayed(PageElement pageElement) {
		...
		try {
			...
			throw new ScriptExecutionException ("Failed to display: '" );
		} finally {
			pageElement = null;
		}
	...
	protected void selectValueFromList(PageElement pageElement, String value) {
		try {
			...
			throw new ScriptExecutionException("Failed to Select value: '" );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void mouseOver(PageElement pageElement) {
		try {
			...
			throw new ScriptExecutionException("Failed to hover mouse: '" );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void switchToFrame(String frameName){
		try {
			...
			throw new ScriptExecutionException ("Failed to switch to Frame: '"   );
		} finally {
			frameName=null;
		}
	}
	...
	protected void clearAndEnterTime(PageElement pageElement){
		try {
			...
			throw new ScriptExecutionException ("Failed to clear and type value: '' in " );
		} finally {
			pageElement = null;
		}
	}
	...
	protected void clearTextField (PageElement pageElement) {
		try {
			...
			throw new ScriptExecutionException ("Failed to Cleared  in "  );
		} finally {
			pageElement = null;
		}
	}
	...
	public boolean verifyConfigTrue(String flag){
