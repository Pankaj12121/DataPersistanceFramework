package com.demo.framework.core.scenarioResult;
...
public class ScenarioExecutionList implements Serializable, Cloneable{
	...
	public String getSerialNumber() {
		setSerialNumber((ScenarioExecutionList.generateExecutionSerialNumber()).toString());
		return serialNumber;
	}
